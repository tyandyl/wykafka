...
public class ConfigDef {
    ...
    public ConfigDef define(ConfigKey key) {
        //configKeys已经在ProducerConfig里配置完了
    ...
    public static class ConfigKey {
        public final String name;//配置参数的名字
        public final Type type;//配置的类型
        public final String documentation;//该配置的文字描述
        public final Object defaultValue;//默认的值
        public final Validator validator;//有效校验器
        public final Importance importance;//重要性
        public final String group;//组
        public final int orderInGroup;//该配置在组内的位置
        public final Width width;
        public final String displayName;
        public final List<String> dependents;//不明白
